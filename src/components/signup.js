...
const Signup = () => {
    ...
    <div className="form-container">
        ...
        <form method="post">
            ...
            <div className="form-group"><button className="btn btn-success btn-block" type="submit">Sign Up</button></div><a className="already" href="#">You already have an account? Login here.</a>
        </form>
    </div>
</div>
    )
